...
CONTAINER="blueretro-build-hw1-3do$$"
OUT="$PROJECT_DIR/artifacts/3do/BlueRetro_hw1_3do.bin"
...
docker cp "$CONTAINER:/work/build/bootloader/bootloader.bin"     "$PROJECT_DIR/artifacts/3do/bootloader.bin"
docker cp "$CONTAINER:/work/build/partition_table/partition-table.bin"     "$PROJECT_DIR/artifacts/3do/partition-table.bin"
docker cp "$CONTAINER:/work/build/ota_data_initial.bin"     "$PROJECT_DIR/artifacts/3do/ota_data_initial.bin"
